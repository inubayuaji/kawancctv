...
@section('content')
    ...
    <section class="bg-green-500">
        <div class="container px-2 mx-auto py-5 md:py-10 text-center text-white">
            ...
            <a href="https://api.whatsapp.com/send/?phone=6281326799339&text=Tanya+paket+dahua+lainya" target="_blank"
                class="btn btn-primary btn-lg" x-on:click="$store.events.contact()">Tanya Paket Dahua</a>
        </div>
    </section>
    <!-- cta end -->
@endsection

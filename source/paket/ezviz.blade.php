...
@section('title', 'Kawan CCTV | Paket CCTV Ezviz')

@section('content')
    @include('_component.header', [
        'title' => 'Paket CCTV > Ezviz',
        'subtitle' => 'Paket CCTV Ezviz untuk anda.',
    ])
                        ...
                        <div class="py-2 px-5">
                            <div class="py-4">
                                <div class="flex justify-center">
                                    ...
                                    <span class="text-base text-8xl font-light">2.2</span>
                                </div>
                            ...
                            <div class="my-5 text-center">
                                <a href="https://api.whatsapp.com/send/?phone=6281326799339&text=Saya+tertarik+paket+2+cctv+ezviz"
                    ...
                    <div class="bg-white rounded-sm hover:shadow-lg ease-linear transition-all duration-150">
                        ...
                        <div class="py-2 px-5">
                            <div class="py-4">
                                <div class="flex justify-center">
                                    <span class="text-lg align-super">Rp</span>
                                    <span class="text-base text-8xl font-light">3.2</span>
                                </div>
                                <span class="text-base text-center block">Juta</span>
                            </div>
                            <div>
                            ...
                            <div class="my-5 text-center">
                                <a href="https://api.whatsapp.com/send/?phone=6281326799339&text=Saya+tertarik+paket+3+cctv+ezviz"
                                    target="_blank" class="btn btn-primary" x-on:click="$store.events.contact()">Dapatkan
                                    Harga</a>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-sm hover:shadow-lg ease-linear transition-all duration-150">
                        ...
                        <div class="py-2 px-5">
                            <div class="py-4">
                                <div class="flex justify-center">
                                    <span class="text-lg align-super">Rp</span>
                                    <span class="text-base text-8xl font-light">4.2</span>
                                </div>
                                <span class="text-base text-center block">Juta</span>
                            </div>
                            <div>
                            ...
                            <div class="my-5 text-center">
                                <a href="https://api.whatsapp.com/send/?phone=6281326799339&text=Saya+tertarik+paket+4+cctv+ezviz"
                                    target="_blank" class="btn btn-primary" x-on:click="$store.events.contact()">Dapatkan
                                    Harga</a>
                            </div>
                        </div>
    ...
    <section class="bg-green-500">
        <div class="container px-2 mx-auto py-5 md:py-10 text-center text-white">
            ...
            <a href="https://api.whatsapp.com/send/?phone=6281326799339&text=Tanya+paket+ezviz+lainya" target="_blank"
                class="btn btn-primary btn-lg" x-on:click="$store.events.contact()">Tanya Paket Ezviz</a>
        </div>
    </section>
    <!-- cta end -->
@endsection
